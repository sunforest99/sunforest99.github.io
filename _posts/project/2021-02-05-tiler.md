...
#### <strong>인게임 화면</strong>
게임이 시작되면 자신 차례에 행동을 할 수 있습니다.<br><br>
<img class="post-img" src="/assets/img/portfolio/tiler/Ingame_0.png" alt=""><br><br>
<hr class="hr-dashed"><br>
...
#### <strong>인게임 화면</strong>
최대 두칸 이동이 가능한 마법사로 적을 공격하러 가겠습니다.<br><br>
<img class="post-img" src="/assets/img/portfolio/tiler/Ingame_5.png" alt=""><br><br>
<hr class="hr-dashed"><br>

#### <strong>인게임 화면</strong>
일정확률로 턴이 시작될때 보급품이 떨어지게 됩니다.<br><br>
<img class="post-img" src="/assets/img/portfolio/tiler/Ingame_6.png" alt=""><br><br>
<hr class="hr-dashed"><br>
...
#### <strong>인게임 화면</strong><br>
식량과 광물중 하나의 재화가 랜덤하게 지급됩니다.<br><br>
<img class="post-img" src="/assets/img/portfolio/tiler/Ingame_8.png" alt=""><br><br>
<hr class="hr-dashed"><br>

#### <strong>인게임 화면</strong>
적의 영역을 발견한 후 침략을 시작했습니다.<br><br>
<img class="post-img" src="/assets/img/portfolio/tiler/Ingame_9.png" alt=""><br><br>
<hr class="hr-dashed"><br>
